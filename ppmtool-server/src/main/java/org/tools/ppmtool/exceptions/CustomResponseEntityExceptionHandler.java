...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler
    public final ResponseEntity<Object> handleUsernameAlreadyExists(UserNotFoundException ex, WebRequest request) {
        return new ResponseEntity<>(UserNotFoundResponse.builder().userNotFound(ex.getMessage()).build(),
