...
public class UserController {
  ...
  public ResponseEntity<?> authenticateUser(
    ...
    JwtLoginSuccessResponse token =
        JwtLoginSuccessResponse.builder().success(true).token(jwt).build();
    return ResponseEntity.ok(token);
  }

  @PostMapping("/register")
  public ResponseEntity<?> register(
      @Valid @RequestBody UserRegisterRequest registerRequest, BindingResult result) {
